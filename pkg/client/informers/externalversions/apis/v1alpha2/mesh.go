	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GatewayV1alpha2().Meshes().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV1alpha2().Meshes().Watch(context.TODO(), options)
			},
		},
		&apisv1alpha2.Mesh{},
		resyncPeriod,
...
func (f *meshInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisv1alpha2.Mesh{}, f.defaultInformer)
}

func (f *meshInformer) Lister() v1alpha2.MeshLister {
	return v1alpha2.NewMeshLister(f.Informer().GetIndexer())
}
